...
class flat_hash_map : public absl::container_internal::raw_hash_map<
 ...
 public:
  ...
  // node_hash_map::num_visited_group()
  //
  // Returns the number of visited groups during search
  using Base::num_visited_group;

  // node_hash_map::num_h2_pass()
  //
  // Returns the number of h2 passes
  using Base::num_h2_pass;
