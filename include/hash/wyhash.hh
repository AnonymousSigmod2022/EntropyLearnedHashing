...
//0: read 8 bytes before and after boundaries, dangerous but fastest. (deleted for readability and this isn't usable in practice)
...
static inline size_t wyhash_default(const void *key, uint64_t len) {
	return wyhash(key, len, 0, _wyp);
}

/* This part of program for random number generation and secret generation */
